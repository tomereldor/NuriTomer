...
Mean ROC-AUC = 0.786 ± 0.077
Mean PR-AUC  = 0.675 ± 0.175
Mean Prec@10% = 0.788 ± 0.206

| Fold | Val n / Train n | ROC-AUC | PR-AUC | P@5% | P@10% | P@20% |
|---|---|---|---|---|---|---|
| fold_0 | 176/174 | 0.916 | 0.930 | 1.000 | 1.000 | 1.000 |
| fold_1 | 350/174 | 0.744 | 0.734 | 1.000 | 1.000 | 0.853 |
| fold_2 | 524/174 | 0.787 | 0.626 | 0.750 | 0.706 | 0.618 |
| fold_3 | 698/174 | 0.717 | 0.454 | 0.375 | 0.529 | 0.559 |
| fold_4 | 872/174 | 0.764 | 0.631 | 0.875 | 0.706 | 0.618 |
...
★ **Best model: LogReg**
Test ROC-AUC = 0.694 | PR-AUC = 0.564
...
|---|---|---|---|
| Best ROC-AUC (test) | N/A | 0.694 | unknown |
| Best Prec@10% (test) | N/A | 0.571 | — |
| Feature count | 49 | 79 | +30 |
...
Threshold ≈ 0.17: prec=0.423  rec=1.000  n=175
...
|---|---|---|
| 1 | feat_company_historical_hit_rate | 0.8000 |
| 2 | feat_prior_large_move_rate_by_phase_x_therapeutic_superclass | 0.7507 |
| 3 | feat_trial_quality_score | 0.6656 |
| 4 | feat_prior_large_move_rate_by_market_cap_bucket | 0.5533 |
| 5 | feat_blinded_flag | 0.4920 |
| 6 | feat_primary_completion_imminent_90d | 0.4500 |
| 7 | feat_enrollment_log | 0.3528 |
| 8 | feat_genetic_basis_unknown | 0.3423 |
| 9 | feat_single_asset_company_flag | 0.3386 |
| 10 | feat_small_trial_flag | 0.3291 |
...
| Fold | Val n / Train n | ROC-AUC | PR-AUC | P@5% | P@10% | P@20% |
|---|---|---|---|---|---|---|
| fold_0 | 176/174 | 0.931 | 0.949 | 1.000 | 1.000 | 1.000 |
| fold_1 | 350/174 | 0.740 | 0.741 | 1.000 | 1.000 | 0.912 |
| fold_2 | 524/174 | 0.796 | 0.658 | 0.750 | 0.824 | 0.765 |
| fold_3 | 698/174 | 0.734 | 0.496 | 0.625 | 0.647 | 0.529 |
| fold_4 | 872/174 | 0.764 | 0.674 | 1.000 | 0.765 | 0.676 |
...
★ **Best model: LogReg**
Test ROC-AUC = 0.702 | PR-AUC = 0.572
Prec@top 5% = 0.800 | @top 10% = 0.571 | @top 20% = 0.571
...
| Metric | v2 Baseline | v3 (timing+priors) | Change |
|---|---|---|---|
| Best ROC-AUC (test) | N/A | 0.702 | unknown |
| Best Prec@10% (test) | N/A | 0.571 | — |
| Feature count | 49 | 70 | +21 |
...
### High-precision watchlist
Threshold ≈ 0.94: prec=1.000  rec=0.014  n=1

### Broad candidate list (best F1)
Threshold ≈ 0.59: prec=0.545  rec=0.649  n=88
...
| Rank | Feature | Importance |
|---|---|---|
| 1 | feat_company_historical_hit_rate | 0.7981 |
| 2 | feat_trial_quality_score | 0.6661 |
| 3 | feat_blinded_flag | 0.4975 |
| 4 | feat_genetic_basis_unknown | 0.4801 |
| 5 | feat_primary_completion_imminent_90d | 0.4389 |
| 6 | feat_enrollment_log | 0.3762 |
| 7 | feat_prior_large_move_rate_by_phase | 0.3714 |
| 8 | feat_small_trial_flag | 0.3412 |
| 9 | feat_late_stage_flag | 0.3374 |
| 10 | feat_single_asset_company_flag | 0.3369 |
...
| Feature | Coverage |
|---|---|
| feat_primary_completion_imminent_30d | 2167/2379 | 91.1% |
| feat_primary_completion_imminent_90d | 2167/2379 | 91.1% |
...
Mean ROC-AUC = 0.762 ± 0.075
Mean PR-AUC  = 0.575 ± 0.157
Mean Prec@10% = 0.673 ± 0.138

| Fold | Val n / Train n | ROC-AUC | PR-AUC | P@5% | P@10% | P@20% |
|---|---|---|---|---|---|---|
| fold_0 | 118/117 | 0.810 | 0.621 | 0.800 | 0.727 | 0.565 |
| fold_1 | 235/117 | 0.758 | 0.370 | 0.200 | 0.455 | 0.435 |
| fold_2 | 352/117 | 0.829 | 0.669 | 0.800 | 0.727 | 0.696 |
| fold_3 | 469/117 | 0.777 | 0.754 | 1.000 | 0.818 | 0.783 |
| fold_4 | 586/117 | 0.637 | 0.460 | 0.800 | 0.636 | 0.304 |
...
| Model | ROC-AUC | PR-AUC | Prec@5% | Prec@10% | Prec@20% |
|---|---|---|---|---|---|
| LogReg | 0.646 | 0.503 | 0.600 | 0.273 | 0.500 |
| LightGBM | 0.681 | 0.603 | 0.800 | 0.636 | 0.682 |
| XGBoost | 0.621 | 0.481 | 0.200 | 0.455 | 0.500 |

★ **Best model: LightGBM**
Test ROC-AUC = 0.681 | PR-AUC = 0.603
Prec@top 5% = 0.800 | @top 10% = 0.636 | @top 20% = 0.682
...
| Metric | v2 Baseline | v3 (timing+priors) | Change |
|---|---|---|---|
| Best ROC-AUC (test) | N/A | 0.681 | unknown |
| Best Prec@10% (test) | N/A | 0.636 | — |
| Feature count | 49 | 70 | +21 |
...
### High-precision watchlist
Threshold ≈ 0.84: prec=1.000  rec=0.045  n=2

### Broad candidate list (best F1)
Threshold ≈ 0.20: prec=0.484  rec=1.000  n=91
...
| Rank | Feature | Importance |
|---|---|---|
| 1 | feat_volatility | 102.0000 |
| 2 | feat_log_market_cap | 81.0000 |
| 3 | feat_cash_runway_proxy | 76.0000 |
| 4 | feat_days_to_primary_completion | 54.0000 |
| 5 | feat_ctgov_pipeline_maturity_score | 52.0000 |
| 6 | feat_ctgov_asset_maturity_score | 49.0000 |
| 7 | feat_n_trials_for_company | 48.0000 |
| 8 | feat_enrollment_log | 42.0000 |
| 9 | feat_asset_trial_share | 40.0000 |
| 10 | feat_company_event_sequence_num | 37.0000 |
...
Mean ROC-AUC = 0.758 ± 0.081
Mean PR-AUC  = 0.570 ± 0.146
Mean Prec@10% = 0.636 ± 0.111

| Fold | Val n / Train n | ROC-AUC | PR-AUC | P@5% | P@10% | P@20% |
|---|---|---|---|---|---|---|
| fold_0 | 118/117 | 0.810 | 0.624 | 0.800 | 0.636 | 0.609 |
| fold_1 | 235/117 | 0.763 | 0.410 | 0.400 | 0.545 | 0.391 |
| fold_2 | 352/117 | 0.815 | 0.615 | 0.400 | 0.636 | 0.696 |
| fold_3 | 469/117 | 0.784 | 0.763 | 1.000 | 0.818 | 0.826 |
| fold_4 | 586/117 | 0.617 | 0.438 | 0.800 | 0.545 | 0.304 |
...
| Model | ROC-AUC | PR-AUC | Prec@5% | Prec@10% | Prec@20% |
|---|---|---|---|---|---|
| LogReg | 0.668 | 0.545 | 0.400 | 0.636 | 0.591 |
| LightGBM | 0.663 | 0.584 | 1.000 | 0.545 | 0.545 |
| XGBoost | 0.628 | 0.484 | 0.400 | 0.455 | 0.455 |

★ **Best model: LogReg**
Test ROC-AUC = 0.668 | PR-AUC = 0.545
Prec@top 5% = 0.400 | @top 10% = 0.636 | @top 20% = 0.591
...
| Metric | v2 Baseline | v3 (timing+priors) | Change |
|---|---|---|---|
| Best ROC-AUC (test) | N/A | 0.668 | unknown |
| Best Prec@10% (test) | N/A | 0.636 | — |
...
### High-precision watchlist
Threshold ≈ 0.92: prec=1.000  rec=0.023  n=1

### Broad candidate list (best F1)
Threshold ≈ 0.22: prec=0.478  rec=1.000  n=92
...
| Rank | Feature | Importance |
|---|---|---|
| 1 | feat_prior_large_move_rate_by_phase | 0.5402 |
| 2 | feat_pipeline_depth_score | 0.5129 |
| 3 | feat_primary_completion_imminent_90d | 0.4721 |
| 4 | feat_primary_completion_imminent_30d | 0.4569 |
| 5 | feat_therapeutic_superclass_Respiratory | 0.4417 |
| 6 | feat_blinded_flag | 0.3676 |
| 7 | feat_enrollment_log | 0.3265 |
| 8 | feat_therapeutic_superclass_Dermatology | 0.2933 |
| 9 | feat_prior_large_move_rate_by_therapeutic_superclass | 0.2339 |
| 10 | feat_randomized_flag | 0.2256 |
...
Mean ROC-AUC = 0.770 ± 0.036
Mean PR-AUC  = 0.599 ± 0.144
Mean Prec@10% = 0.745 ± 0.235

| Fold | Val n / Train n | ROC-AUC | PR-AUC | P@5% | P@10% | P@20% |
|---|---|---|---|---|---|---|
| fold_0 | 118/117 | 0.789 | 0.655 | 1.000 | 0.818 | 0.609 |
| fold_1 | 235/117 | 0.745 | 0.400 | 0.400 | 0.455 | 0.348 |
| fold_2 | 352/117 | 0.823 | 0.690 | 1.000 | 0.909 | 0.652 |
| fold_3 | 469/117 | 0.757 | 0.748 | 1.000 | 1.000 | 0.739 |
| fold_4 | 586/117 | 0.734 | 0.502 | 0.200 | 0.545 | 0.609 |
...
| Model | ROC-AUC | PR-AUC | Prec@5% | Prec@10% | Prec@20% |
|---|---|---|---|---|---|
| LogReg | 0.654 | 0.555 | 0.600 | 0.727 | 0.591 |
| LightGBM | 0.659 | 0.562 | 0.600 | 0.636 | 0.591 |
| XGBoost | 0.614 | 0.455 | 0.200 | 0.364 | 0.455 |

★ **Best model: LightGBM**
Test ROC-AUC = 0.659 | PR-AUC = 0.562
Prec@top 5% = 0.600 | @top 10% = 0.636 | @top 20% = 0.591
...
| Metric | v2 Baseline | v3 (timing+priors) | Change |
|---|---|---|---|
| Best ROC-AUC (test) | N/A | 0.659 | unknown |
| Best Prec@10% (test) | N/A | 0.636 | — |
| Feature count | 49 | 64 | +15 |
...
### High-precision watchlist
Threshold ≈ 0.93: prec=1.000  rec=0.045  n=2

### Broad candidate list (best F1)
Threshold ≈ 0.12: prec=0.472  rec=0.955  n=89
...
| Rank | Feature | Importance |
|---|---|---|
| 1 | feat_volatility | 350.0000 |
| 2 | feat_cash_runway_proxy | 248.0000 |
| 3 | feat_log_market_cap | 214.0000 |
| 4 | feat_ctgov_asset_maturity_score | 162.0000 |
| 5 | feat_enrollment_log | 160.0000 |
| 6 | feat_company_event_sequence_num | 154.0000 |
| 7 | feat_ctgov_pipeline_maturity_score | 129.0000 |
| 8 | feat_n_trials_for_company | 128.0000 |
| 9 | feat_ctgov_n_late_stage_trials_sponsor | 104.0000 |
| 10 | feat_asset_trial_share | 99.0000 |
