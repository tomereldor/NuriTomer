...
DATE_TAG = "20260401"
VERSION  = 18  # Pass-10: Open Targets genetics features (evidence-based replacement for LLM genetics)
               # feat_ot_genetic_basis, feat_ot_genetic_evidence_score, feat_ot_n_genetic_targets
               # feat_ot_monogenic_signal, feat_ot_gwas_signal, feat_ot_somatic_signal
               # Replaces LLM-derived feat_genetic_basis_encoded + feat_heritability_proxy_score.
               # All 6 features grounded in Open Targets Platform curated databases.
...
NUMERIC_FEATURES_V1 = [
    ...
    # ── v18: Open Targets genetics features (pass-10) ──
    # Evidence-based replacement for LLM-derived genetics features.
    # Generated by scripts/enrich_opentargets_genetics.py --full --write-features
    # These are conditionally included — skipped if not present in the feature dataset.
    "feat_ot_genetic_evidence_score",   # float 0-1: max(monogenic, gwas, cancer_somatic) from OT
    "feat_ot_n_genetic_targets",        # int: count of targets with curated monogenic evidence (top 100)
...
ORDINAL_UNKNOWN_NEG1 = [
    ...
    # ── v18: Open Targets genetics basis (pass-10) ──
    "feat_ot_genetic_basis",       # 0=none, 1=polygenic, 2=somatic, 3=monogenic; -1=unknown
]
