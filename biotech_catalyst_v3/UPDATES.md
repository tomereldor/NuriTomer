...
- Ready to split into train/val/test immediately — no further preprocessing required
...
- Generated by `build_ml_ready_features.py` (pass1) → `add_high_value_predictors.py` (pass3)

**`ml_feature_dict_20260310_v2.csv`** — feature dictionary
