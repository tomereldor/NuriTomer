...
**`ml_dataset_features_v0.3_20260313.csv`** ← THE ONE FILE TO USE FOR ML TRAINING
- **827 rows × 132 cols** — v0.3 adds 9 timing/sequence features on top of pass-4 feature set
...
- Generated by `add_pre_event_timing_features.py` (pass5, v0.3)

**`ml_feature_dict_v0.3_20260313.csv`** — feature dictionary (69 entries)
- Schema: feature_name, stage, feature_type, description, source_columns, source_type, n_valid, n_null, pct_valid
...
### 2026-03-13 — Pre-event model v0.3: timing features + fold-safe priors (v3.23)

**Naming convention update:** files now use `{name}_v{version}_{date}` — version first, date last, cumulative semver (v0.3, v0.4 …)

**Feature dataset:** `ml_dataset_features_v0.3_20260313.csv` (827 rows × 132 cols, +9 new timing features)
**Feature dict:** `ml_feature_dict_v0.3_20260313.csv` (69 entries)
**Train table:** `ml_baseline_train_v0.3_20260313.csv` (813 rows, 64 features + split)
**Report:** `reports/ml_pre_event_report_v0.3_20260313.md`
